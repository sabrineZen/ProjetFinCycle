...
function MesCommandes({ profil }){
    const fullName = [profil?.prenom, profil?.nom].filter(Boolean).join(" ");
    const commandes=[          
                {id:"#1240",userId: 6,date:"15 mars 2026",articles: 5,etat:"Livrée",prix: 5000},
                {id:"#1241",userId: 6,date:"20 mars 2026",articles: 3,etat:"En Cours",prix: 1800},
                {id:"#1242",userId: 7, date:"25 mars 2026",articles: 2,etat:"Annulée",prix: 1200},
                {id:"#1243",userId: 6,date:"31 mars 2026",articles: 3,etat:"Livrée",prix: 1000},
                {id:"#1244",userId: 7,date:"2 Avril 2026",articles: 4,etat:"En Cours",prix: 1500},
                {id:"#1245",userId: 6, date:"10 Avril 2026",articles: 1,etat:"Annulée",prix: 500}

            ]
            const commandesAffichees = commandes.filter(cmd => !profil?.id || cmd.userId === profil.id);
            const styles = {
    ...
    return(
        <div className="space-y-4">
            ...
            {commandesAffichees.length === 0 ? (
              <p className="text-gray-500">Aucune commande disponible pour ce profil.</p>
