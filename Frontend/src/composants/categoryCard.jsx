function CategoryCard({ couleur, category, hoverClass }) {
  return (
    <div className={`shadow-lg p-4 w-[260px] h-[260px] sm:w-[320px] sm:h-[320px] md:w-[400px] md:h-[400px] rounded-[30px] flex justify-center items-center flex-shrink-0 flex-col ${hoverClass}`} style={{ background: couleur }}>
