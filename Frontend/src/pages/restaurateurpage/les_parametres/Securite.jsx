        ...
        <div className="space-y-8 max-w-3xl">
          ...
          <div className="space-y-3">
            ...
            <input 
              type="password" 
              placeholder="••••••••"
              className="w-full  border-1 bg-[#FFF7F4] border-[#C0A0A0] rounded-xl py-3 px-8 font-regular text-[#951418] focus:ring-1 focus:ring-[#FF843D] transition-all outline-none" 
            />
          </div>
